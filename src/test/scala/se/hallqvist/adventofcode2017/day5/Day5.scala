package se.hallqvist.adventofcode2017.day5
...
-1030
  ...
  def part1(s: String) = {
    val mem: mutable.Seq[Int] = s.split("\n").map(_.trim).filter(!_.isEmpty).map(_.toInt)
    var pc = 0
    var cnt = 0
